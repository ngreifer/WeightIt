...
## Propensity score weighting using GLMs (`method = "ps"`)
...
### Binary and multicatgeory treatments with `link = "br.logit"`
...
### Multicategory treatments with `link = "bayes.probit"`

For multicategory treatments, when `link = "bayes.probit"`, the `MNP` package is required for Bayesian multinomial probit regression. To install `MNP` from CRAN, run
