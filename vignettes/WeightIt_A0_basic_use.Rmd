...
In this case, our confidence intervals were similar. Bootstrapping can take some time, especially with weight estimation methods that take longer, such as SuperLearner (`method = "super"`),  covariate balancing propensity score estimation (`method = "cbps"`), or entropy balancing with `stabilize = TRUE`. 
...
bal.tab(list(tx1 ~ age + gender + use0,
        ...
        data = iptwExWide, m.threshold = .05, disp.ks = TRUE,
        which.time = .all)
```
