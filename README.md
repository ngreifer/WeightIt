...
*WeightIt* is a one-stop package to generate balancing weights and
censoring weights for point and longitudinal treatments in observational
studies. Support is included for binary, multi-category, and continuous
treatments; a variety of estimands including the ATE, ATT, ATC, ATO, and
others; and for a wide variety of weighting methods, including those
that rely on parametric modeling, machine learning, or optimization.
...
| Energy balancing<sup>†</sup> | [`"energy"`](https://ngreifer.github.io/WeightIt/reference/method_energy.html) | ✓ | ✓ | ✓ | ✓ |
...
propensity score (GPS). <sup>†</sup>With a continuous treatment,
`"energy"` performs distance covariance optimal weighting.
